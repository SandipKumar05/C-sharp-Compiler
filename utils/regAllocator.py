import utils.symbolTable as SymbolTable
import pprint
    ...
    def getRegister(self, arg, offset):
        ...
        if len(self.freeReg) > 0:  # if there is a register available
            ...
            for (
                ...
                self.varDescripter.iteritems()
            ):  # find the variable for which this register was being used. nullify it
                if value == reg:
            ...
            self.varDescripter[
                var
            ] = reg  # set this variable to be contained in register
            # print "dsb "+reg
